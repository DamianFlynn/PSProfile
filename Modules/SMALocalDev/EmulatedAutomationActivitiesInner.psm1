$SmaWebServiceDetails = @{
    "WebServiceEndpoint" = "https://sma.staging.lionbridge.com";
       # I currently have a number of environments online, for reference these are the FQDNs
       # LIOX Staging = https://sma.staging.lionbridge
       # LIOX Production = https://servicemanagementautomation.lionbridge.com
    "Port" = 9090;
    ...
    $CredUsername = "bil-s-sc-sma01\administrator"
    $CredPassword = "!Reset123"
...
function Get-AutomationVariable {
    ...
    Get-AutomationAsset -Type Variable -Name $Name
}
